...
typedef enum lm_token_type_e {
    ...
    LM_TOKEN_TYPE_OP_INCREASE_BY,
    LM_TOKEN_TYPE_OP_DECREASE_BY,
    LM_TOKEN_TYPE_OP_INCREASE,
    LM_TOKEN_TYPE_OP_DECREASE,
    LM_TOKEN_TYPE_OP_MULTIPLY_BY,
    LM_TOKEN_TYPE_OP_DIVIDE_BY,
